...
(function() {
    ...
    function autoPost() {
        ...
        //在窗口中添加一个标题
        postWindow.document.title = "发帖模板";
        //标题输入框
        ...
        button.style = "padding: 3px 8px; text-align: center; font-size: 18px; margin: 6px 110px; cursor: pointer";
        ...
        button1.innerHTML = "生成帖子";
        button1.onclick = infoCreate;
        button1.style = "padding: 3px 8px; text-align: center; font-size: 18px; margin: 6px 110px; cursor: pointer";
